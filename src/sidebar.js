...
export function renderSidebar(container, { skills, selectedName, activeTags, activePlatforms, searchQuery, onSelect, onSearch, onTagToggle, onPlatformToggle }) {
  ...
  container.innerHTML = `
    ...
    <div class="p-3 border-t border-[rgba(0,255,100,0.08)] flex items-center gap-2.5">
      <img
        src="https://avatars.githubusercontent.com/u/6198891?v=4"
        alt="Norlihazmey"
        width="36"
        height="36"
        class="rounded-full flex-shrink-0 border border-[rgba(0,255,100,0.2)] opacity-80"
      />
      <div class="min-w-0">
        <div class="font-mono text-[10px] text-[rgba(0,255,100,0.5)] font-medium mb-0.5 truncate">Norlihazmey</div>
        <div class="font-mono text-[9px] text-[rgba(0,255,100,0.25)] mb-1 truncate">norlihazmey.ghazali@gmail.com</div>
        <a
          href="https://github.com/metallurgical"
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-1 font-mono text-[9px] text-[rgba(0,255,100,0.35)] hover:text-[rgba(0,255,100,0.7)] transition-colors"
        >
